...
def run(
	...
	return os.path.join(PATH_RESULT_ABSOLUTE,f'{BC.name_vid}_brief.mp4')
...
def track_briefcam(inputts, objectt, type_vehicle, start_times, camseris, ipaddress, fps_result):
	...
	URL_VIDEOBRIEF_STORAGE = f"http://s3.openstack.demo.mqsolutions.vn/v1/{auth_token}/video_summary"
