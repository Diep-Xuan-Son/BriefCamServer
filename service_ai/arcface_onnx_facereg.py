...
class FaceRegRunnable():
    ...
    def __init__(self, model_path, imgsz, conf_thres, device):
        ...
        if str(device) in ['0', '1', '2', '3', 'cuda:0', 'cuda:1', 'cuda:2', 'cuda:3']:
    ...
    def get_feature(self, ims, dets):
        ...
        for i, im in enumerate(ims):
            ...
            if biggestBox is not None:
                ...
                outputs.append(facenet_fingerprint)
        return outputs
    ...
    def compare_face_1_n_n(self, feature1, feature2):
        dist = np.linalg.norm(feature - feature1, axis=2)
